...
namespace U_Commerce.Controllers
{
    public class CommentController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,ProductId,UserId,DateTime,Ip,Comment")] ProductComment productComment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ProductId,UserId,DateTime,Ip,Comment")] ProductComment productComment)
        {
            if (ModelState.IsValid)
            {
